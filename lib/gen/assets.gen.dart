...
class $AssetsDummyGen {
  ...
  /// File path: assets/dummy/ddds.png
  AssetGenImage get ddds => const AssetGenImage('assets/dummy/ddds.png');
  ...
  /// List of all assets
  List<dynamic> get values => [amico, bro, d, ddd, ddds, fa, logo, pana, sh];
}
